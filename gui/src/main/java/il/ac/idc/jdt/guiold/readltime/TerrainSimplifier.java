package il.ac.idc.jdt.guiold.readltime;
...
/**
 * This class is responsible for simplifying a terrain received as input. The
 * simplification process in done using Terra. The simplified terrain can than
 * be used to build a triangulation and be presented graphically.
 * 
 * @author NS
 * 
 */
public class TerrainSimplifier {
	...
	/**
	 * The percentage of number of points that the simplified terrain should
	 * contain.
	 */
	 ...
	 *            The path to the Terra executable.
	 * @param outputFile
	 *            The name of the output file of Terra.
	 * @param outputFormat
	 *            The format of the output file of Terra.
	 * @throws IOException
	 * 
	 */
	public TerrainSimplifier(String terrainFilename, String terraExePath, String outputFile) throws IOException {
		...
		m_numberOfPoints = getNumberOfPointsInTheTerrain() * PERCENTAGE_OF_POINTS_IN_THE_SIMPLIFIED_TERRAIN / 100;
	}

	/**
	 * Simplifies the terrain and returns an ArrayList of Triangle_dt objects
	 * that represents the triangulation.
	 * 
	 * @return An ArrayList of Triangle_dt objects that represents the
	 *         triangulation.
	 * @throws Exception
	 */
	public Vector<Triangle> triangulate() throws Exception {

		String whatToExecute = "-p " + m_numberOfPoints.toString() + " -o " + m_outputFile + Consts.TERRA_TRIANGULATION_OUTPUT_FILE_EXT
		...
		return SmfToTriangles.getTriangles(m_outputFile + Consts.TERRA_TRIANGULATION_OUTPUT_FILE_EXT);
	}
	...
	public void simplify() throws Exception {
		String whatToExecute = "-p " + m_numberOfPoints.toString() + " -o " + m_outputFile + Consts.TERRA_SIMPLIFICATION_OUTPUT_FILE_EXT
