...
/**
 * Represents a 3D point. used by the topographic map algorithm. In order to get
 * good accuracy big decimal where used.
 * 
 * @author Omri
 * 
 */
public class Point_tp {
	 ...
	 * @param pointDt
	 */
	public Point_tp(Point pointDt) {
		_x = new BigDecimal(pointDt.getX());
		_y = new BigDecimal(pointDt.getY());
		_z = pointDt.getZ();
	}
