...
public class TriangleCrossingLinesCalculator {
	 ...
	 * @return
	 */
	public static ArrayList<Line_tp> getLines(Triangle t, double dz) {

		Point_tp p1 = new Point_tp(t.getA());
		Point_tp p2 = new Point_tp(t.getB());
		Point_tp p3 = new Point_tp(t.getC());
	...
	/**
	 * Computes all the points in the height dz * k when dz * k is between
	 * p1.getZ() and p2.getZ() excluding p1.getZ() and p2.getZ();
	 */
